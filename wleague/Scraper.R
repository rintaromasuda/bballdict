...
write.table(df_result, file = "WLeaguePlayerName_RawData_202122.csv", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = ",", fileEncoding = "UTF-8")

df_tsv <- df_result
df_tsv$PoS <- "人名"

write.table(df_tsv, file = "WLeaguePlayerName_TSV_UTF8_202122.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t", fileEncoding = "UTF-8")
